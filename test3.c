...
int main(__attribute__((unused)) int argc, __attribute__((unused)) char *argv[])
{
	...
	write_png_image("out/test2d.png", (unsigned char *) image2d, WIDTH, HEIGHT, 1);
	write_png_image("out/test3d.png", (unsigned char *) image3d, WIDTH, HEIGHT, 1);
	write_png_image("out/test4d.png", (unsigned char *) image4d, WIDTH, HEIGHT, 1);
